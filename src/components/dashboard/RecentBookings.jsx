        ...
        <div className="flex flex-col gap-6">
            ...
            {viewMode === 'calendar' ? (
                <div className="animate-in fade-in zoom-in-95 duration-300">
                    <ShareholderCalendarView bookings={bookings} />
                </div>
            ) : (
                <div className="bg-card border rounded-lg shadow-sm overflow-hidden mb-8 animate-in fade-in slide-in-from-right-4 duration-300">
