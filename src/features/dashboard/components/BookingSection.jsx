                        ...
                        <div className="w-full bg-card rounded-xl shadow-sm border overflow-hidden animate-in fade-in slide-in-from-right-4 duration-300">
                            <div className="p-6 md:p-8 flex flex-col items-center justify-center space-y-8 min-h-[300px]">
                                <div className="text-center space-y-2">
                                    ...
                                    <p className="text-slate-500 font-medium text-sm">Trailer occupancy limit is 6 guests.</p>
                                </div>

                                <div className="flex items-center gap-6">
                                    <button
                                        onClick={() => handleInputChange({ target: { name: 'guests', value: Math.max(1, parseInt(formData.guests) - 1) } })}
                                        className="w-12 h-12 rounded-full bg-slate-100 text-slate-400 hover:bg-slate-200 hover:text-slate-600 flex items-center justify-center transition-all active:scale-95 disabled:opacity-50"
                                    ...
                                    <div className="w-16 text-center">
                                        <span className="text-4xl font-black text-slate-800 tracking-tighter">{formData.guests}</span>
                                    </div>

                                    <button
                                        onClick={() => handleInputChange({ target: { name: 'guests', value: Math.min(6, parseInt(formData.guests) + 1) } })}
                                        className="w-12 h-12 rounded-full bg-primary text-primary-foreground hover:bg-primary/90 flex items-center justify-center transition-all shadow-lg shadow-primary/20 active:scale-95 disabled:opacity-50"
