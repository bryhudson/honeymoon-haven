       ...
       <div style="margin-top: 40px; padding-top: 20px; border-top: 1px solid #f5f5f7;">
          ...
          <div style="margin-top: 24px;">
            <a href="https://maps.app.goo.gl/MLWgdWVQdqBoQpGR7">
              <img src="https://hhr-trailer-booking.web.app/hhr-location-map-v2.png" alt="Map Location of Honeymoon Haven Resort" style="width: 100%; max-width: 600px; border-radius: 12px; border: 1px solid #e5e5ea; display: block;">
            </a>
          </div>
       </div>
    `;
