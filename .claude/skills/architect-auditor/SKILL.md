...
description: Use when auditing the HHR codebase for architectural integrity, redundancy, modularity, feature-folder alignment, or before major refactors. Ruthless cleanup-focused review of structure, hygiene, security, and performance.
---
